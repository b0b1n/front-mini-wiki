...
<head>
  ...
  <title>Se connecter --MiniWiki</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="http://localhost:8080/Mini-Wiki/list"><b>Mini Wiki</b></a>
  ...
  <div class="main">
    ...
    <form action= "login"  method="post">
      <input class="un " type="email" align="center" name="login" placeholder="Email" required="required" >
      <input class="pass" type="password" align="center" name="password" placeholder="Password" required="required">
      <input type="submit" class="submit" align="center" value="Connecter">
      <p class="forgot" align="center"><a href="rewatch">Mot de passe oublié?</p>
      </form>      
  </div>
