...
<head>
  ...
  <title>Réinitialisation du mot de passe --MiniWiki</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="list">Accueil</a>
        </li>
      </ul>
   </div>
  </div>
  ...
  <div class="main">
    <p class="sign" align="center">Réinitialisation du mot de passe</p>
    <form action= "rewatch"  method="post">
      <input class="un " type="email" align="center" name="email" placeholder="Email" required="required" >
      <input class="pass" type="password" align="center" name="password" placeholder="New Password" required="required">
      <input type="submit" class="submit"  value="Réinitialiser">
