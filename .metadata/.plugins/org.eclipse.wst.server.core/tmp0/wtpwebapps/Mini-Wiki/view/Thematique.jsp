  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="them">Ajouter Thematiques</a>
        </li>
        <c:if test="${ weaer != null }">
        <c:forEach items="${weaer}" var="we">
        <li class="nav-item">
          <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">${ we.username.toString().substring(1, we.username.toString().length()-1) }</a>
        </li>
        </c:forEach>
        </c:if>
      </ul>
	...
	<div class="main">
		<p class="sign" align="center">Ajouter une thématiques</p>
			...
			<form action="them" method="post">
				<input class="un" input type="text" placeholder="Ecrire ici"
					name="sous" required="required" /> <select name="ids" class="un">
		...
		</select> <input class="un" type="color" name="color" placeholder="color"
			required="required"> <input type="submit" class="submit"
			align="center" value="Ajouter">
